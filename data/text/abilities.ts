export const AbilitiesText: {[k: string]: AbilityText} = {
	...
	hayveil: {
		...
		transform: "Changed to Flock Forme!",
		transformEnd: "Changed to Scarecrow Forme!",
	},
	raingrow: {
		name: "Raingrow",
		desc: "If this Pokemon is a Monsoonura and Rain Dance is active, it changes to Chunky Form. If this Pokemon is a Monsoonura and it is holding Utility Umbrella, it remains in its regular form. If this Pokemon is a Monsoonura in its Chunky form and is given Utility Umbrella, it will immediately switch back to its regular form. If this Pokemon is a Monsoonura holding Utility Umbrella and its item is removed while Rain Dance is active, it will transform into its Chunky Form. If an ally is holding Utility Umbrella while Monsoonura is in its Chunky Form.",
		shortDesc: "If user is Monsoonura and Rain Dance is active, it changes to Chunky Form.",
	},
